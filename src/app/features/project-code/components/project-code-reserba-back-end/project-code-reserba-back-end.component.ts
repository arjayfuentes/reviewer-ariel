...
@Component({
  selector: 'app-project-code-reserba-back-end',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './project-code-reserba-back-end.component.html',
  styleUrl: './project-code-reserba-back-end.component.css',
})
export class ProjectCodeReserbaBackEndComponent implements OnInit {
  readonly OWNER = 'arjayfuentes';
  readonly REPO = 'reserba-backend';
  ...
  getFileIcon(node: TreeNode): string {
    if (node.type === 'folder') {
      return node.expanded ? 'pi-folder-open' : 'pi-folder';
    }
