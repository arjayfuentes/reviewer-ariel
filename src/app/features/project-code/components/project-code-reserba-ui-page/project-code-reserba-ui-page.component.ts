...
@Component({
  selector: 'app-project-code-reserba-ui-page',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './project-code-reserba-ui-page.component.html',
  styleUrl: './project-code-reserba-ui-page.component.css',
})
export class ProjectCodeReserbaUiPageComponent implements OnInit {
  readonly OWNER = 'arjayfuentes';
  readonly REPO = 'reviewer-ariel';
