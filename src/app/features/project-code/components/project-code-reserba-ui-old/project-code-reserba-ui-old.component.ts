...
@Component({
  selector: 'app-project-code-reserba-ui-old',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './project-code-reserba-ui-old.component.html',
  styleUrl: './project-code-reserba-ui-old.component.css',
})
export class ProjectCodeReserbaUiOldComponent implements OnInit {
  readonly OWNER = 'arjayfuentes';
  readonly REPO = 'reserba-ui-old';
