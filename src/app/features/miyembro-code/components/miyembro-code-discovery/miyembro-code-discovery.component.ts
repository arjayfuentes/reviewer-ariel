...
@Component({
  selector: 'app-miyembro-code-discovery', // ← change
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './miyembro-code-discovery.component.html', // ← change
  styleUrl: './miyembro-code-discovery.component.css', // ← change
})
export class MiyembroCodeDiscoveryComponent implements OnInit {
  // ← change

  readonly OWNER = 'miyembro';
  readonly REPO = 'discovery'; // ← change
