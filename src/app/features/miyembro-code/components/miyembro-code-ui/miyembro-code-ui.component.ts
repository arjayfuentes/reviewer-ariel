...
@Component({
  selector: 'app-miyembro-code-ui', // ← change
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './miyembro-code-ui.component.html', // ← change
  styleUrl: './miyembro-code-ui.component.css', // ← change
})
export class MiyembroCodeUiComponent implements OnInit {
  // ← change

  readonly OWNER = 'miyembro';
  readonly REPO = 'miyembro-ui'; // ← change
