...
@Component({
  selector: 'app-miyembro-code-deployment', // ← change
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './miyembro-code-deployment.component.html', // ← change
  styleUrl: './miyembro-code-deployment.component.css', // ← change
})
