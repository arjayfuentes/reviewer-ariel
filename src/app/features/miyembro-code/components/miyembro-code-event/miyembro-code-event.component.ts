...
@Component({
  selector: 'app-miyembro-code-event', // ← change
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './miyembro-code-event.component.html', // ← change
  styleUrl: './miyembro-code-event.component.css', // ← change
})
export class MiyembroCodeEventComponent implements OnInit {
  // ← change

  readonly OWNER = 'miyembro';
  readonly REPO = 'event'; // ← change
