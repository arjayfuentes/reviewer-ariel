...
@Component({
  selector: 'app-miyembro-code-email', // ← change
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './miyembro-code-email.component.html', // ← change
  styleUrl: './miyembro-code-email.component.css', // ← change
})
export class MiyembroCodeEmailComponent implements OnInit {
  // ← change

  readonly OWNER = 'miyembro';
  readonly REPO = 'email'; // ← change
