...
@Component({
  selector: 'app-miyembro-code-gateway', // ← change
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './miyembro-code-gateway.component.html', // ← change
  styleUrl: './miyembro-code-gateway.component.css', // ← change
})
export class MiyembroCodeGatewayComponent implements OnInit {
  // ← change

  readonly OWNER = 'miyembro';
  readonly REPO = 'gateway'; // ← change
