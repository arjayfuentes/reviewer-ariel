...
@Component({
  selector: 'app-miyembro-code-config-server', // ← change
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './miyembro-code-config-server.component.html', // ← change
  styleUrl: './miyembro-code-config-server.component.css', // ← change
})
export class MiyembroCodeConfigServerComponent implements OnInit {
  // ← change

  readonly OWNER = 'miyembro';
  readonly REPO = 'config-server'; // ← change
