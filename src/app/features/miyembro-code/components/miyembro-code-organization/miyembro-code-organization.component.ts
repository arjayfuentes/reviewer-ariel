...
@Component({
  selector: 'app-miyembro-code-organization', // ← change
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './miyembro-code-organization.component.html', // ← change
  styleUrl: './miyembro-code-organization.component.css', // ← change
})
export class MiyembroCodeOrganizationComponent implements OnInit {
  // ← change

  readonly OWNER = 'miyembro';
  readonly REPO = 'organization'; // ← change
